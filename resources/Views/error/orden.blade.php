    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            ...
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase error-subtitle">ERROR!</h3>
                <p class="text-muted mt-4 mb-4">EL N° DE PEDIDO NO ES VALIDO.</p>
                <p class="text-muted mt-4 mb-4"> FAVOR INGRESAR UN NUMERO DE ORDEN VALIDO
                    SI EL PROBLEMA PERSISTE PONGASE EN CONTACTO!</P>

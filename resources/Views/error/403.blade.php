...
<head>
    ...
    <title>Appnet Store - Panel admin</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            ...
            <div class="error-body text-center">
                ...
                <h3 class="text-uppercase error-subtitle">ERROR DE ACCESSO!</h3>
                <p class="text-muted mt-4 mb-4">NO TIENES PERMISOS PARA ACCEDER A ESTE SERVICIO.</p>
                <a href="/" class="btn btn-info btn-rounded waves-effect waves-light mb-5">Volver al Inicio</a> 
            </div>
            <!-- ---------------------
                end error-403
            ---------------- -->

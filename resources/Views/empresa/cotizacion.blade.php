...
#formadepago label:nth-of-type(2) {
  margin: 0 20px;
  padding: 0;
  text-align: center;
}
...
<div class="card">
    <div class="card-header d-flex">
        ...
        <div class="ms-auto flex-shrink-0">
            <div class="btn-group">
                <a class="btn btn-secondary" href="{{ route('empresas.index') }}"><i class="fas fa-arrow-left"></i> volver</a>
            </div>
        </div>
    </div>
</div>
@if($empresa->emp_tipo == 2)
<div class="card">
    <div class="row">
            ...
            <div class="card-body wizard-content">
                ...
                <form enctype="multipart/form-data" class=" form-material" id="formu">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" value="{{$empresa->id}}" name="emp_id">
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" required  name="emp_contacto" value='<?=$empresa->emp_contacto ? $empresa->emp_contacto : old('emp_mail')?>'>
        ...
        <div class="card-body">
            <form class="form-horizontal">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="mb row">
                            <label for="fname2" class="col-sm control-label col-form-label">RUT Empresa</label>
                            <div class="col-sm">
                                <input type="text" class="form-control" id="fname2" readonly value="{{ $empresa->emp_rut }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="mb row">
                            ...
                            <div class="col-sm">
                                <input type="text" class="form-control" id="lname2" readonly value="{{$empresa->emp_nombre}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="mb row">
                            ...
                            <div class="col-sm">
                                <input type="email" readonly class="form-control" value="{{ $empresa->emp_giro }}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="mb row">
                            <label for="nname" class="col-sm control-label col-form-label">Contacto</label>
                            <div class="col-sm">
                                <input type="text" readonly class="form-control" value="{{ $empresa->emp_contacto }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="mb row">
                            ...
                            <div class="col-sm">
                                <input type="text" readonly class="form-control" value="{{ $empresa->emp_mail }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="mb row">
                            ...
                            <div class="col-sm">
                                <input type="text" readonly class="form-control" value="{{ $empresa->emp_telefono }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="mb row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" readonly class="form-control" value="{{  $empresa->dir_calle."  #".$empresa->dir_numero." , ".$empresa->com_nombre." , ".$empresa->reg_nombre." , ".$empresa->pai_nombre }}">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="m_repeater_section mt-4">
                    <form id="frompro">
                        @csrf
                        <input type="hidden"  name="id_cotizacion"value="<?=$cotizacion ? $cotizacion->id : Cotizacion($empresa->id)?>">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-2 row">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <div class="input-group">
                            <div class="input-group">
                                <span class="radio col-12">
                                    <label class="col-2 text-end">
                                    <input type="radio" class="radiobox" name="cot_destipo" value="2">
                                    <span>$</span> 
                                    </label>
                                    <label class="col-4 text-center">Tipo descuento</label>
                                    <label>
                                    <input type="radio" class="radiobox" name="cot_destipo" value="1">
                                    <span>%</span> 
                                    </label>
                                </span>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-3">
                        <div class="b-label">
                            <label for="inputEmail3" class="control-label col-form-label">Forma de pago:</label>
                        </div>
                    </div>
                    <div class="col-9">
                        <div class="input-group" id="formadepago">
                            <span class="radio col-12">
                              <label class="col-2 text-end">
                                <input type="radio" class="radiobox" name="formapago">
                                <span>Contado</span> 
                              </label>
                              <label class="col-4 text-center">Pagara</label>
                              <label>
                                <input type="radio" class="radiobox" name="formapago">
                                <span>Credito</span> 
                              </label>
                        ...
                        <select class="form-select select2" id="id_formadepago" name="id_formadepago">
                        </select>
                    </div>
                </div>
                <div class="form-group row">
...
<script>
    $(function(){
        ...
        $("input[name=cot_destipo]").on('change', function()
        {
            destipo = $(this).val();
            console.log(destipo)
            $("#cot_des_total").val(0);
            $("#cot_total_coti").val(total);
        });
...
<script>
    ...
    $(function(){
        ...
        $("#btn-next").click( async function(e){
            ...
            const request = await fetch("{{ route('cotizaciones.store') }}", {
                method: 'POST',
                body: formData
            });
